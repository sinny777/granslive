...
module.exports = function(io, watson, bluemix) {
	
	var sttCred = bluemix.getServiceCreds('speech_to_text');
  	sttCred.version = "v1";
  	var speechToText = watson.speech_to_text(sttCred);
    ...
    socket.on('message', function(data) {
      ...
      if (!session.open) {
        ...
        var payload = {
          ...
          content_type: 'audio/l16; rate=' + (data.rate || 44100),
          continuous: true,
